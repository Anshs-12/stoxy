...
export const Login = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-[70vh]">
      <div className="max-w-md w-full bg-surface card-border border border-border-light rounded px-8 py-10 flex flex-col items-center text-center">
        <div className="h-16 w-16 bg-neutral rounded-full flex items-center justify-center mb-6">
          <Shield className="h-7 w-7 text-muted" />
        </div>
        
        <h1 className="text-2xl font-heading font-medium tracking-tight text-primary mb-3">Sign in to Stoxy</h1>
        <p className="text-sm font-sans text-muted mb-10 max-w-[280px]">
        ...
        <p className="mt-8 text-[11px] text-muted font-sans uppercase tracking-widest">
