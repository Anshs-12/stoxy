...
const Dashboard = lazy(() =>
    import("./components/pages/Dashboard").then((m) => ({
        default: m.Dashboard,
    })),
);
const StockDetails = lazy(() =>
    import("./components/pages/StockDetails").then((m) => ({
        default: m.StockDetails,
    })),
);
...
const StockSearch = lazy(() =>
    import("./components/pages/StockSearch").then((m) => ({
        default: m.StockSearch,
    })),
);
const StockScreener = lazy(() =>
    import("./components/pages/StockScreener").then((m) => ({
        default: m.StockScreener,
    })),
);
const Watchlist = lazy(() =>
    import("./components/pages/Watchlist").then((m) => ({
        default: m.Watchlist,
    })),
);
const Portfolio = lazy(() =>
    import("./components/pages/Portfolio").then((m) => ({
        default: m.Portfolio,
    })),
);
const Login = lazy(() =>
